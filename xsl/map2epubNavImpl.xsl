<xsl:stylesheet version="2.0"
  ...
  <!-- ============================================================================= 
       ...
       Generate the navigation structures for the EPUB, the <nav> structure for EPUB3,
       toc.ncx for EPUB 3.
       
       Implements modes "generate-toc" and "epub:generate-nav"
       
       NOTE: Mode generate-toc is for the EPUB2 toc.ncx file. Mode generate-nav is
       for the EPUB3 <nav> document.
  ...
  <xsl:template mode="epub:generate-nav" match="*">
    <xsl:apply-templates mode="#current"/>
  </xsl:template>
  
  <xsl:template mode="epub:generate-nav" match="text()">
